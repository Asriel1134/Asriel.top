<script setup>
    ...
    const codeAge = calcTime()

    const noteNumAll = ref(24)

    function calcTime(){
        let dateNow = new Date();
        let dateStart = new Date(2022, 9, 1);
        let difftime = (dateNow - dateStart)/1000;
        let year = parseInt(difftime/86400/365);
        return year;
    }
</script>
    ...
    <div class="noteContainer">
        <div class="personalInformation">
            <div class="personInfo">
                ...
                <div class="infoSide">
                    <a class="name">Asriel</a>
                    <a class="codeAge">码龄{{codeAge}}年</a>
                </div>
            </div>
            <div class="countBox">
                <div class="count">
                    <span class="countNumber">{{noteNumAll}}</span>
                    <span class="countTag">笔记</span>
                </div>
                <a class="borderH"></a>
                <div class="count">
                    <span class="countNumber">{{noteNumAll}}</span>
...
.borderW {
    ...
    background-image: linear-gradient(to right, rgba(247, 247, 247, 1), rgba(60, 60, 60, 0.12), rgba(247, 247, 247, 1));
}
.borderH {
    width: 1px;
    height: 47px;
    /* background-color: #000; */
    background-image: linear-gradient(rgba(247, 247, 247, 1), rgba(60, 60, 60, 0.12), rgba(247, 247, 247, 1));
}
.avatar {
    margin-left: 30px;
    width: 58px;
...
.borderHTop {
    width: 1px;
    height: 100px;
    background-image: linear-gradient(rgba(247, 247, 247, 1), rgba(60, 60, 60, 0.12));
}
.borderHBottom {
    width: 1px;
    height: 100px;
    background-image: linear-gradient(rgba(60, 60, 60, 0.12), rgba(247, 247, 247, 1));
}
</style>